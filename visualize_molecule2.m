function  d = visualize_molecule2(coord,thr,figure_num,molecule_name)
...
xlabel('X (sigma)','fontsize',14,'interpreter','latex');
ylabel('Y (sigma)','fontsize',14,'interpreter','latex');
zlabel('Z (sigma)','fontsize',14,'interpreter','latex');

title(molecule_name,'fontsize',14,'interpreter','latex');
